...
driver.find_element_by_xpath("//div[text()='Reviews']").click()

time.sleep(3)

driver.find_element_by_xpath("//span[text()='Write a review']").click()

time.sleep(2)

driver.find_element_by_xpath("/html/body/div/c-wiz/div/div/div/c-wiz/div").click()
